...
import inloco.clients.jedis.BinaryClient.LIST_POSITION;
import inloco.clients.jedis.exceptions.InvalidURIException;
...
import inloco.clients.util.JedisByteHashMap;
import inloco.clients.util.JedisURIHelper;
...
public class BinaryJedis implements BasicCommands, BinaryJedisCommands, MultiKeyBinaryCommands,
  ...
  public String calcGeotargeting(String bucket, String targetingId, String campaignId,
    ...
    checkIsInMultiOrPipeline();
    client.calcGeotargetings(bucket, targetingId, campaignId, latitude, longitude, radius);
    return client.getStatusCodeReply();
  }
